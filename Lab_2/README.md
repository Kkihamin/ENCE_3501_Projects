...
3. [Layout](#paragraph3)
    ...
    2. [Padframe](#Padframe)
    3. [DAC] (#DAC)
    4. [Padframe with DAC](#Padframe with DAC)
...
## Pad <a name="Pad"></a>
   1. Figure 4 below shows the layout of the Pad which was created from following a tutorial.
      <img width="603" alt="Pad layout" src="https://github.com/Kkihamin/ENCE_3501_Projects/assets/129350322/d5491859-6699-441c-a07f-07cf1ccd0ddf">

      Figure 4: Layout of Pad

## Padframe <a name="Padframe"></a>
   1. Figure 5 below shows the layout of the Padframe created from making a 4 by 4 array of the layout of the pad.
      <img width="610" alt="Padframe" src="https://github.com/Kkihamin/ENCE_3501_Projects/assets/129350322/b8dd27dc-901a-4fb4-87dd-f625cb883c5b">

      Figure 5: Padframe layout

## DAC <a name="DAC"></a>
   1. Figure 6 below shows the layout of the DAC edited from Lab 1.
      <img width="644" alt="DAC" src="https://github.com/Kkihamin/ENCE_3501_Projects/assets/129350322/cd4be1bb-cb80-42ee-87bb-9d3b18cd8a21">

      Figure 6: Layout of the DAC

## Padframe with DAC <a name="Padframe with DAC"></a>
   1. Figure 7 below shows the layout of the DAC wired to the respective pins on the Padframe.
